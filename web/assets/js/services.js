function onDocumentReady(t) {
    function e() {
        ...
        $(window).width();
        t < 400 && (t = 400), sliderHeight = t + 400, $("#services_main .bx-viewport").css({
            height: sliderHeight
        })
    }
    $(".icon").hover(function() {
        $(this).toggleClass("active"), $(this).closest(".table-cell").find(".icon-text").toggleClass("active"), $(".icon").toggleClass("inactive"), $(".icon-text").toggleClass("inactive")
...
window.Modernizr = function(t, e, i) {
        ...
        for (var D in k) f(k, D) && (h = D.toLowerCase(), p[h] = k[D](), P.push((p[h] ? "" : "no-") + h));
    ...
    function(t, e, i) {
        ...
        function E(t, e, i, n, r) {
            for (var o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > o; o += 2) "margin" === i && (s += ot.css(t, i + Rt[o], !0, r)), n ? ("content" === i && (s -= ot.css(t, "padding" + Rt[o], !0, r)), "margin" !== i && (s -= ot.css(t, "border" + Rt[o] + "Width", !0, r))) : (s += ot.css(t, "padding" + Rt[o], !0, r), "padding" !== i && (s += ot.css(t, "border" + Rt[o] + "Width", !0, r)));
            return s
        }
        ...
        function D(t, e) {
            for (var i, n, r, o = [], s = 0, a = t.length; a > s; s++) n = t[s], n.style && (o[s] = Ct.get(n, "olddisplay"), i = n.style.display, e ? (o[s] || "none" !== i || (n.style.display = ""), "" === n.style.display && Dt(n) && (o[s] = Ct.access(n, "olddisplay", C(n.nodeName)))) : (r = Dt(n), "none" === i && r || Ct.set(n, "olddisplay", r ? i : ot.css(n, "display"))));
        ...
        function L(t, e) {
            ...
            for (e = e ? 1 : 0; 4 > n; n += 2 - e) i = Rt[n], r["margin" + i] = r["padding" + i] = t;
        ...
        var ut = function(t) {
            function e(t, e, i, n) {
                ...
                if (!n && ((e ? e.ownerDocument || e : q) !== D && R(e), e = e || D, N)) {
                    if (11 !== g && (c = vt.exec(t)))
                        if (r = c[1]) {
                            if (9 === g) {
                ...
                var r = i.length > 0,
                    ...
                    s = function(n, s, a, l, c) {
                        var u, h, f, d = 0,
                            ...
                            w = y.length;
                        for (c && (A = s === D || s || c); p !== w && null != (u = y[p]); p++) {
                            if (o && u) {
                                for (h = 0, s || u.ownerDocument === D || (R(u), a = !N); f = t[h++];)
                                    if (f(u, s || D, a)) {
                                        l.push(u);
                                        break
                                    } c && (H = x)
            ...
            var x, w, b, T, S, C, k, P, A, O, E, R, D, M, N, L, I, j, F, z = "sizzle" + 1 * new Date,
                q = t.document,
                H = 0,
                B = 0,
                X = i(),
            ...
            w = e.support = {}, S = e.isXML = function(t) {
                ...
                return n !== D && 9 === n.nodeType && n.documentElement ? (D = n, M = D.documentElement, N = !S(D), (i = D.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", bt, !1) : i.attachEvent && i.attachEvent("onunload", bt)), w.attributes = r(function(t) {
                    return t.className = "i", !t.getAttribute("className")
                }), w.getElementsByTagName = r(function(t) {
                    return t.appendChild(D.createComment("")), !t.getElementsByTagName("*").length
                }), w.getElementsByClassName = mt.test(D.getElementsByClassName), w.getById = r(function(t) {
                    return M.appendChild(t).id = z, !D.getElementsByName || !D.getElementsByName(z).length
                ...
                }, I = [], L = [], (w.qsa = mt.test(D.querySelectorAll)) && (r(function(t) {
                ...
                })), (w.matchesSelector = mt.test(j = M.matches || M.webkitMatchesSelector || M.mozMatchesSelector || M.oMatchesSelector || M.msMatchesSelector)) && r(function(t) {
                    w.disconnectedMatch = j.call(t, "div"), j.call(t, "[s!='']:x"), I.push("!=", ot)
                    ...
                    return i ? i : (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !w.sortDetached && e.compareDocumentPosition(t) === i ? t === D || t.ownerDocument === q && F(q, t) ? -1 : e === D || e.ownerDocument === q && F(q, e) ? 1 : O ? tt(O, t) - tt(O, e) : 0 : 4 & i ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return E = !0, 0;
                    var i, n = 0,
                        r = t.parentNode,
                ...
                if ((t.ownerDocument || t) !== D && R(t), i = i.replace(ut, "='$1']"), w.matchesSelector && N && !Y[i + " "] && (!I || !I.test(i)) && (!L || !L.test(i))) try {
                    var n = j.call(t, i);
                    if (n || w.disconnectedMatch || t.document && 11 !== t.document.nodeType) return n
                } catch (r) {}
                return e(i, D, null, [t]).length > 0
            }, e.contains = function(t, e) {
                return (t.ownerDocument || t) !== D && R(t), F(t, e)
            }, e.attr = function(t, e) {
            ...
            }, w.sortStable = z.split("").sort($).join("") === z, w.detectDuplicates = !!E, R(), w.sortDetached = r(function(t) {
        ...
        ot.event = {
            ...
            fix: function(t) {
                ...
                var e, i, n, r = t.type,
                    o = t,
                    s = this.fixHooks[r];
                for (s || (this.fixHooks[r] = s = zt.test(r) ? this.mouseHooks : Ft.test(r) ? this.keyHooks : {}), n = s.props ? this.props.concat(s.props) : this.props, t = new ot.Event(o), e = n.length; e--;) i = n[e], t[i] = o[i];
        ...
        ot.extend({
            ...
            ot.cssHooks[t + e] = {
                expand: function(i) {
                    for (var n = 0, r = {}, o = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) r[t + Rt[n] + e] = o[n] || o[n - 2] || o[0];
                    return r
                }
        ...
        ot.param = function(t, e) {
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var t = this.type;
                    return this.name && !ot(this).is(":disabled") && Me.test(this.nodeName) && !De.test(t) && (this.checked || !Mt.test(t))
                }).map(function(t, e) {
                    var i = ot(this).val();
        ...
        ot.ajaxSetup({
            ...
            var r, o, s, a = e.jsonp !== !1 && (je.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && je.test(e.data) && "data");
            return a || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = ot.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(je, "$1" + r) : e.jsonp !== !1 && (e.url += (_e.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
        ...
        t.fn.bxSlider = function(n) {
            ...
            if (!t(o).data("bxSlider")) {
                var l = function() {
                    ...
                    c = function() {
                        ...
                        o.wrap('<div class="' + r.settings.wrapperClass + '"><div class="bx-viewport"></div></div>'), r.viewport = o.parent(), r.settings.ariaLive && !r.settings.ticker && r.viewport.attr("aria-live", "polite"), r.loader = t('<div class="bx-loading" />'), r.viewport.prepend(r.loader), o.css({
                            ...
                            display: "block"
                        })), r.controls.el = t('<div class="bx-controls" />'), r.settings.captions && S(), r.active.last = r.settings.startSlide === m() - 1, r.settings.video && o.fitVids(), ("all" === r.settings.preloadImages || r.settings.ticker) && (e = r.children), r.settings.ticker ? r.settings.pager = !1 : (r.settings.controls && b(), r.settings.auto && r.settings.autoControls && T(), r.settings.pager && w(), (r.settings.controls || r.settings.autoControls || r.settings.pager) && r.viewport.after(r.controls.el)), u(e, h)
                    },
                    u = function(e, i) {
                    ...
                    y = function(e, i, n, s) {
                        ...
                        }) : R()) : "reset" === i ? o.css(r.animProp, l) : "ticker" === i && (o.css("-" + r.cssPrefix + "-transition-timing-function", "linear"), o.css(r.animProp, l), 0 !== n ? o.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function(e) {
                    ...
                    x = function() {
                        for (var e = "", i = "", n = m(), o = 0; n > o; o++) i = "", r.settings.buildPager && t.isFunction(r.settings.buildPager) || r.settings.pagerCustom ? (i = r.settings.buildPager(o), r.pagerEl.addClass("bx-custom-pager")) : (i = o + 1, r.pagerEl.addClass("bx-default-pager")), e += '<div class="bx-pager-item"><a href="" data-slide-index="' + o + '" class="bx-pager-link">' + i + "</a></div>";
                        r.pagerEl.html(e)
                    },
                    w = function() {
                        r.settings.pagerCustom ? r.pagerEl = t(r.settings.pagerCustom) : (r.pagerEl = t('<div class="bx-pager" />'), r.settings.pagerSelector ? t(r.settings.pagerSelector).html(r.pagerEl) : r.controls.el.addClass("bx-has-pager").append(r.pagerEl), x()), r.pagerEl.on("click touchend", "a", O)
                    },
                    b = function() {
                        r.controls.next = t('<a class="bx-next" href="">' + r.settings.nextText + "</a>"), r.controls.prev = t('<a class="bx-prev" href="">' + r.settings.prevText + "</a>"), r.controls.next.bind("click touchend", C), r.controls.prev.bind("click touchend", k), r.settings.nextSelector && t(r.settings.nextSelector).append(r.controls.next), r.settings.prevSelector && t(r.settings.prevSelector).append(r.controls.prev), r.settings.nextSelector || r.settings.prevSelector || (r.controls.directionEl = t('<div class="bx-controls-direction" />'), r.controls.directionEl.append(r.controls.prev).append(r.controls.next), r.controls.el.addClass("bx-has-controls-direction").append(r.controls.directionEl))
                    },
                    T = function() {
                        r.controls.start = t('<div class="bx-controls-auto-item"><a class="bx-start" href="">' + r.settings.startText + "</a></div>"), r.controls.stop = t('<div class="bx-controls-auto-item"><a class="bx-stop" href="">' + r.settings.stopText + "</a></div>"), r.controls.autoEl = t('<div class="bx-controls-auto" />'), r.controls.autoEl.on("click", ".bx-start", P), r.controls.autoEl.on("click", ".bx-stop", A), r.settings.autoControlsCombine ? r.controls.autoEl.append(r.controls.start) : r.controls.autoEl.append(r.controls.start).append(r.controls.stop), r.settings.autoControlsSelector ? t(r.settings.autoControlsSelector).html(r.controls.autoEl) : r.controls.el.addClass("bx-has-controls-auto").append(r.controls.autoEl), D(r.settings.autoStart ? "stop" : "start")
                    },
                    S = function() {
                    ...
                    L = function() {
                        ...
                        "next" === r.settings.autoDirection ? o.append(r.children.clone().addClass("bx-clone")) : (o.prepend(r.children.clone().addClass("bx-clone")), e = r.children.first().position(), h = "horizontal" === r.settings.mode ? -e.left : -e.top), y(h, "reset", 0), r.settings.pager = !1, r.settings.controls = !1, r.settings.autoControls = !1, r.settings.tickerHover && (r.usingCSS ? (s = "horizontal" === r.settings.mode ? 4 : 5, r.viewport.hover(function() {
                    ...
                    I = function(t) {
                        ...
                        "next" === r.settings.autoDirection ? a = o.find(".bx-clone").first().position() : l = r.children.first().position(), e = "horizontal" === r.settings.mode ? -a.left : -a.top, i = "horizontal" === r.settings.mode ? -l.left : -l.top, n = {
                            resetValue: i
                        }, y(e, "ticker", s, n)
                    },
                    j = function(e) {
                ...
                return o.goToSlide = function(e, i) {
                    ...
                    }, r.settings.pause), r.settings.autoControls && t !== !0 && D("stop"))
                }, o.stopAuto = function(t) {
                    r.interval && (clearInterval(r.interval), r.interval = null, r.settings.autoControls && t !== !0 && D("start"))
                    ...
                    r.children.add(o.find(".bx-clone")).outerWidth(p()), r.viewport.css("height", f()), r.settings.ticker || _(), r.active.last && (r.active.index = m() - 1), r.active.index >= m() && (r.active.last = !0), r.settings.pager && !r.settings.pagerCustom && (x(), E(r.active.index)), r.settings.ariaHidden && Y(r.active.index * v())
            ...
            function() {
                ...
                var u, h, f, d, p, g, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                    ...
                    G = q.convertToPixels = function(t, i, n, r, o) {
                        ...
                        if (d && (n = -n), "%" === r && -1 !== i.indexOf("border")) a = n / 100 * (u ? t.clientWidth : t.clientHeight);
                            ...
                            h.appendChild(F), a = parseFloat(F[u ? "offsetWidth" : "offsetHeight"]), h.removeChild(F), u && "%" === r && s.cacheWidths !== !1 && (l = h._gsCache = h._gsCache || {}, l.time = c, l.width = a / n * 100), 0 !== a || o || (a = G(t, i, n, r, !0))
                        }
                        return d ? -a : a
                    },
                    ...
                    K = function(t, e) {
                        ...
                        return B || (o.opacity = X(t)), n = jt(t, e, !1), o.rotation = n.rotation, o.skewX = n.skewX, o.scaleX = n.scaleX, o.scaleY = n.scaleY, o.x = n.x, o.y = n.y, Pt && (o.z = n.z, o.rotationX = n.rotationX, o.rotationY = n.rotationY, o.scaleZ = n.scaleZ), o.filters && delete o.filters, o
                    },
                ...
                var ft = function(t, e, i, n) {
                    ...
                    vt = s.parseComplex = function(t, e, i, n, r, o, s, a, l, c) {
                        ...
                        var h, f, d, p, g, _, y, x, w, b, T, S, C, k = i.split(", ").join(",").split(" "),
                            ...
                            A = k.length,
                            O = u !== !1;
                        for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (k = k.join(" ").replace(D, ", ").split(" "), P = P.join(" ").replace(D, ", ").split(" "), A = k.length), A !== P.length && (k = (o || "").split(" "), A = k.length), s.plugin = l, s.setRatio = c, ht.lastIndex = 0, h = 0; A > h; h++)
                ...
                var bt, Tt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    Dt = function() {
                        ...
                        return I.createElementNS && !n && (t = Et("svg", Rt), e = Et("rect", t, {
                            width: 100,
                            height: 50,
                            x: 100
                        }), i = e.getBoundingClientRect().width, e.style[kt] = "50% 50%", e.style[St] = "scaleX(0.5)", n = i === e.getBoundingClientRect().width && !(d && Pt), Rt.removeChild(t)), n
                    }(),
                    ...
                    jt = q.getTransform = function(t, i, n, o) {
                        ...
                        if (d.svg = !(!t.getBBox || !Nt(t)), d.svg && (Mt(t, Q(t, kt, r, !1, "50% 50%") + "", d, t.getAttribute("data-svg-origin")), bt = s.useSVGTransformAttr || Dt), a = It(t), a !== Lt) {
                            if (16 === a.length) {
                                var y, x, w, b, T, S = a[0],
                                    C = a[1],
                                    k = a[2],
                                    ...
                                    z = a[11],
                                    q = Math.atan2(E, L);
                                d.zOrigin && (F = -d.zOrigin, I = D * F - a[12], j = M * F - a[13], F = L * F + d.zOrigin - a[14]), d.rotationX = q * N, q && (b = Math.cos(-q), T = Math.sin(-q), y = A * b + D * T, x = O * b + M * T, w = E * b + L * T, D = A * -T + D * b, M = O * -T + M * b, L = E * -T + L * b, z = R * -T + z * b, A = y, O = x, E = w), q = Math.atan2(-k, L), d.rotationY = q * N, q && (b = Math.cos(-q), T = Math.sin(-q), y = S * b - D * T, x = C * b - M * T, w = k * b - L * T, M = C * T + M * b, L = k * T + L * b, z = P * T + z * b, S = y, C = x, k = w), q = Math.atan2(C, S), d.rotation = q * N, q && (b = Math.cos(-q), T = Math.sin(-q), S = S * b + A * T, x = C * b + O * T, O = C * -T + O * b, E = k * -T + E * b, C = x), d.rotationX && Math.abs(d.rotationX) + Math.abs(d.rotation) > 359.9 && (d.rotationX = d.rotation = 0, d.rotationY = 180 - d.rotationY), d.scaleX = (Math.sqrt(S * S + C * C) * m + .5 | 0) / m, d.scaleY = (Math.sqrt(O * O + M * M) * m + .5 | 0) / m, d.scaleZ = (Math.sqrt(E * E + L * L) * m + .5 | 0) / m, d.skewX = 0, d.perspective = z ? 1 / (0 > z ? -z : z) : 0, d.x = I, d.y = j, d.z = F, d.svg && (d.x -= d.xOrigin - (d.xOrigin * S - d.yOrigin * A), d.y -= d.yOrigin - (d.yOrigin * C - d.xOrigin * O))
                    ...
                    Ft = function(t) {
                        ...
                        if (f) {
                            ...
                            if (null != n.ox && (d = (n.oxp ? m * n.ox * .01 : n.ox) - m / 2, p = (n.oyp ? v * n.oy * .01 : n.oy) - v / 2, b += d - (d * a + p * l), T += p - (d * c + p * u)), _ ? (d = m / 2, p = v / 2, y += ", Dx=" + (d - (d * a + p * l) + b) + ", Dy=" + (p - (d * c + p * u) + T) + ")") : y += ", sizingMethod='auto expand')", -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? h.filter = e.replace(R, y) : h.filter = y + " " + e, (0 === t || 1 === t) && 1 === a && 0 === l && 0 === c && 1 === u && (_ && -1 === y.indexOf("Dx=0, Dy=0") || w.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && h.removeAttribute("filter")), !_) {
                                var S, C, k, P = 8 > g ? 1 : -1;
                    ...
                    zt = q.set3DTransformRatio = q.setTransformRatio = function(t) {
                        var e, i, n, r, o, s, a, l, c, u, h, f, p, g, m, v, _, y, x, w, b, T, S, C = this.data,
                            ...
                            F = C.perspective,
                            z = C.force3D;
                        if (((1 === t || 0 === t) && "auto" === z && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !z) && !I && !F && !O && !A && 1 === D || bt && j || !Pt) return void(P || C.skewX || j ? (P *= M, T = C.skewX * M, S = 1e5, e = Math.cos(P) * E, r = Math.sin(P) * E, i = Math.sin(P - T) * -R, o = Math.cos(P - T) * R, T && "simple" === C.skewType && (_ = Math.tan(T), _ = Math.sqrt(1 + _ * _), i *= _, o *= _, C.skewY && (e *= _, r *= _)), j && (N += C.xOrigin - (C.xOrigin * e + C.yOrigin * i) + C.xOffset, L += C.yOrigin - (C.xOrigin * r + C.yOrigin * o) + C.yOffset, bt && (C.xPercent || C.yPercent) && (g = this.t.getBBox(), N += .01 * C.xPercent * g.width, L += .01 * C.yPercent * g.height), g = 1e-6, g > N && N > -g && (N = 0), g > L && L > -g && (L = 0)), x = (e * S | 0) / S + "," + (r * S | 0) / S + "," + (i * S | 0) / S + "," + (o * S | 0) / S + "," + N + "," + L + ")", j && bt ? this.t.setAttribute("transform", "matrix(" + x) : k[St] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + x) : k[St] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix(" : "matrix(") + E + ",0,0," + R + "," + N + "," + L + ")");
                        if (d && (g = 1e-4, g > E && E > -g && (E = D = 2e-5), g > R && R > -g && (R = D = 2e-5), !F || C.z || C.rotationX || C.rotationY || (F = 0)), P || C.skewX) P *= M, m = e = Math.cos(P), v = r = Math.sin(P), C.skewX && (P -= C.skewX * M, m = Math.cos(P), v = Math.sin(P), "simple" === C.skewType && (_ = Math.tan(C.skewX * M), _ = Math.sqrt(1 + _ * _), m *= _, v *= _, C.skewY && (e *= _, r *= _))), i = -v, o = m;
                        else {
                            if (!(O || A || 1 !== D || F || j)) return void(k[St] = (C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) translate3d(" : "translate3d(") + N + "px," + L + "px," + I + "px)" + (1 !== E || 1 !== R ? " scale(" + E + "," + R + ")" : ""));
                            e = o = 1, i = r = 0
                        }
                        c = 1, n = s = a = l = u = h = 0, f = F ? -1 / F : 0, p = C.zOrigin, g = 1e-6, w = ",", b = "0", P = O * M, P && (m = Math.cos(P), v = Math.sin(P), a = -v, u = f * -v, n = e * v, s = r * v, c = m, f *= m, e *= m, r *= m), P = A * M, P && (m = Math.cos(P), v = Math.sin(P), _ = i * m + n * v, y = o * m + s * v, l = c * v, h = f * v, n = i * -v + n * m, s = o * -v + s * m, c *= m, f *= m, i = _, o = y), 1 !== D && (n *= D, s *= D, c *= D, f *= D), 1 !== R && (i *= R, o *= R, l *= R, h *= R), 1 !== E && (e *= E, r *= E, a *= E, u *= E), (p || j) && (p && (N += n * -p, L += s * -p, I += c * -p + p), j && (N += C.xOrigin - (C.xOrigin * e + C.yOrigin * i) + C.xOffset, L += C.yOrigin - (C.xOrigin * r + C.yOrigin * o) + C.yOffset), g > N && N > -g && (N = b), g > L && L > -g && (L = b), g > I && I > -g && (I = 0)), x = C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix3d(" : "matrix3d(", x += (g > e && e > -g ? b : e) + w + (g > r && r > -g ? b : r) + w + (g > a && a > -g ? b : a), x += w + (g > u && u > -g ? b : u) + w + (g > i && i > -g ? b : i) + w + (g > o && o > -g ? b : o), A || O || 1 !== D ? (x += w + (g > l && l > -g ? b : l) + w + (g > h && h > -g ? b : h) + w + (g > n && n > -g ? b : n), x += w + (g > s && s > -g ? b : s) + w + (g > c && c > -g ? b : c) + w + (g > f && f > -g ? b : f) + w) : x += ",0,0,0,0,1,0,", x += N + w + L + w + I + w + (F ? 1 + -I / F : 1) + ")", k[St] = x
                    };
                c = At.prototype, c.x = c.y = c.z = c.skewX = c.skewY = c.rotation = c.rotationX = c.rotationY = c.zOrigin = c.xPercent = c.yPercent = c.xOffset = c.yOffset = 0, c.scaleX = c.scaleY = c.scaleZ = 1, xt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                    parser: function(t, e, i, n, o, a, l) {
                        ...
                        var c, u, h, f, d, p, g, m, v, _, y = t._gsTransform,
                            ...
                            S = {},
                            C = "transformOrigin";
                        if (l.display ? (f = Q(t, "display"), x.display = "block", c = jt(t, r, !0, l.parseTransform), x.display = f) : c = jt(t, r, !0, l.parseTransform), n._transform = c, "string" == typeof T.transform && St) f = F.style, f[St] = T.transform, f.display = "block", f.position = "absolute", I.body.appendChild(F), u = jt(F, null, !1), I.body.removeChild(F), u.perspective || (u.perspective = c.perspective), null != T.xPercent && (u.xPercent = ot(T.xPercent, c.xPercent)),
                            null != T.yPercent && (u.yPercent = ot(T.yPercent, c.yPercent));
                ...
                c = s.prototype, c._firstPT = c._lastParsedTransform = c._transform = null, c._onInitTween = function(t, e, a) {
                    ...
                    if (h && "" === T.zIndex && (c = Q(t, "zIndex", r), ("auto" === c || "" === c) && this._addLazySet(T, "zIndex", 0)), "string" == typeof e && (m = T.cssText, c = K(t, r), T.cssText = m + ";" + e, c = J(t, c, K(t)).difs, !B && b.test(e) && (c.opacity = parseFloat(RegExp.$1)), e = c, T.cssText = m), e.className ? this._firstPT = d = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = d = this.parse(t, e, null), this._transformType) {
                        ...
                        x = new gt(t, "transform", 0, 0, null, 2), this._linkCSSP(x, null, g), x.setRatio = St ? zt : Ft, x.data = this._transform || jt(t, r, !0), x.tween = a, x.pr = -1, o.pop()
                    }
                    if (i) {
                        for (; d;) {
        ...
        if (!i.TweenLite) {
            ...
            var R = v("TweenLite", function(e, i, n) {
                    ...
                    if (this._overwrite = l = null == l ? Y[R.defaultOverwrite] : "number" == typeof l ? l >> 0 : Y[l], (a || e instanceof Array || e.push && d(e)) && "number" != typeof e[0])
                        for (this._targets = s = h(e), this._propLookup = [], this._siblings = [], r = 0; r < s.length; r++) o = s[r], o ? "string" != typeof o ? o.length && o !== t && o[0] && (o[0] === t || o[0].nodeType && o[0].style && !o.nodeType) ? (s.splice(r--, 1),
                            this._targets = s = s.concat(h(o))) : (this._siblings[r] = G(o, this, !1), 1 === l && this._siblings[r].length > 1 && K(o, this, null, 1, this._siblings[r])) : (o = s[r--] = R.selector(o), "string" == typeof o && s.splice(r + 1, 1)) : s.splice(r--, 1);
            ...
            o = R.prototype = new A, o.constructor = R, o.kill()._gc = !1, o.ratio = 0, o._firstPT = o._targets = o._overwrittenProps = o._startAt = null, o._notifyPluginsOfEnabled = o._lazy = !1, R.version = "1.18.2", R.defaultEase = o._ease = new x(null, null, 1, 1), R.defaultOverwrite = "auto", R.ticker = s, R.autoSleep = 120, R.lagSmoothing = function(t, e) {
                s.lagSmoothing(t, e)
            ...
            var N = [],
                ...
                F = function(t, e, i, n) {
                    ...
                    return d += e.substr(f), d && h.push(d), h.setRatio = j, h
                },
                z = function(t, e, i, n, r, o, s, a) {
                    ...
                    return "number" !== h && ("function" === h && "get" === i && (c = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3), d.s = u = s ? t[c](s) : t[c]()), "string" == typeof u && (s || isNaN(u)) ? (d.fp = s, l = F(u, n, a || R.defaultStringFilter, d), d = {
                        t: l,
                        p: "setRatio",
                        s: 0,
                        c: 1,
            ...
            U._startTime = s.time, $._startTime = s.frame, U._active = $._active = !0, setTimeout(Q, 1), A._updateRoot = R.render = function() {
                var t, e, i;
                if (N.length && Q(), U.render((s.time - U._startTime) * U._timeScale, !1, !1), $.render((s.frame - $._startTime) * $._timeScale, !1, !1), N.length && Q(), s.frame >= V) {
                    ...
                    if (i = U._first, (!i || i._paused) && R.autoSleep && !$._first && 1 === s._listeners.tick.length) {
            ...
            o._init = function() {
                ...
                if (o.startAt) {
                    ...
                    } if (this._ease = c = c ? c instanceof x ? c : "function" == typeof c ? new x(c, o.easeParams) : w[c] || R.defaultEase : R.defaultEase, o.easeParams instanceof Array && c.config && (this._ease = c.config.apply(c, o.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
            ...
            if (o = tt.prototype, tt.version = "1.18.0", tt.API = 2, o._firstPT = null, o._addTween = z, o.setRatio = j, o._kill = function(t) {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function(t, e, i) {
            var n, r, o, s, a, l, c, u, h = {
                ...
                Rt = "ontouchstart" in _ && "orientation" in window,
                Dt = function(t) {
                ...
                Mt = function(t, e, i, n) {
                    t.addEventListener ? t.addEventListener(Dt[e] || e, i, n) : t.attachEvent && t.attachEvent("on" + e, i)
                },
                Nt = function(t, e, i) {
                    t.removeEventListener ? t.removeEventListener(Dt[e] || e, i) : t.detachEvent && t.detachEvent("on" + e, i)
                },
                Lt = function(t, e) {
                ...
                It = function(t) {
                    r = t.touches && D < t.touches.length, Nt(t.target, "touchend", It)
                },
                jt = function(t) {
                    r = t.touches && D < t.touches.length, Mt(t.target, "touchend", It)
                },
                ...
                zt = function(t) {
                    var e;
                    return !(!t || !t.getAttribute || "BODY" === t.nodeName) && (!("true" !== (e = t.getAttribute("data-clickable")) && ("false" === e || !t.onclick && !R.test(t.nodeName + "") && "true" !== t.getAttribute("contentEditable"))) || zt(t.parentNode))
                },
                qt = function(t, e) {
                ...
                Xt = function(n, s) {
                    t.call(this, n), n = K(n), o || (o = g.com.greensock.plugins.ThrowPropsPlugin), this.vars = s = F(s || {}), this.target = n, this.x = this.y = this.rotation = 0, this.dragResistance = parseFloat(s.dragResistance) || 0, this.edgeResistance = isNaN(s.edgeResistance) ? 1 : parseFloat(s.edgeResistance) || 0, this.lockAxis = s.lockAxis, this.autoScroll = s.autoScroll || 0, this.lockedAxis = null, this.allowEventDefault = !!s.allowEventDefault;
                    var a, l, c, u, m, y, x, b, A, R, L, z, B, W, Y, Q, J, et, it, nt, rt, ot, ct, ut, ht, ft, dt, pt, gt, mt, vt, _t, yt, xt = (s.type || (k ? "top,left" : "x,y")).toLowerCase(),
                        ...
                        Gt = function() {
                            var t, e, i, r;
                            x = !1, l ? (l.calibrate(), Et.minX = R = -l.maxScrollLeft(), Et.minY = z = -l.maxScrollTop(), Et.maxX = A = Et.maxY = L = 0, x = !0) : s.bounds && (t = lt(s.bounds, n.parentNode), bt ? (Et.minX = R = t.left, Et.maxX = A = t.left + t.width, Et.minY = z = Et.maxY = L = 0) : void 0 !== s.bounds.maxX || void 0 !== s.bounds.maxY ? (t = s.bounds, Et.minX = R = t.minX, Et.minY = z = t.minY, Et.maxX = A = t.maxX, Et.maxY = L = t.maxY) : (e = lt(n, n.parentNode), Et.minX = R = st(n, Tt) + t.left - e.left, Et.minY = z = st(n, St) + t.top - e.top, Et.maxX = A = R + (t.width - e.width), Et.maxY = L = z + (t.height - e.height)), R > A && (Et.minX = A, Et.maxX = A = R, R = Et.minX), z > L && (Et.minY = L, Et.maxY = L = z, z = Et.minY), bt && (Et.minRotation = R, Et.maxRotation = A), x = !0), s.liveSnap && (i = s.liveSnap === !0 ? s.snap || {} : s.liveSnap, r = i instanceof Array || "function" == typeof i, bt ? (nt = ne(r ? i : i.rotation, R, A, 1), rt = null) : (Pt && (nt = ne(r ? i : i.x || i.left || i.scrollLeft, R, A, l ? -1 : 1)), At && (rt = ne(r ? i : i.y || i.top || i.scrollTop, z, L, l ? -1 : 1))))
                        },
                        Zt = function() {
                        ...
                        Jt = function(t, e) {
                            ...
                            }, bt ? t.rotation = Ft(Et, r ? i : i.rotation, A, R, 1, e) : (Pt && (t[Tt] = Ft(Et, r ? i : i.x || i.left || i.scrollLeft, A, R, l ? -1 : 1, e || "x" === Et.lockedAxis)), At && (t[St] = Ft(Et, r ? i : i.y || i.top || i.scrollTop, L, z, l ? -1 : 1, e || "y" === Et.lockedAxis)))), Et.isThrowing = !0, c = isNaN(s.overshootTolerance) ? 1 === s.edgeResistance ? 0 : 1 - Et.edgeResistance + .2 : s.overshootTolerance, Et.tween = a = o.to(l || n, {
                                throwProps: t,
                        ...
                        ee = function() {
                            ...
                            te(), l ? (Gt(), y = l.top(), m = l.left()) : (ie() ? (Qt(!0, !0), Gt()) : Et.applyBounds(), bt ? (J = kt(n, {
                                x: 0,
                                y: 0
                            }), Qt(!0, !0), m = Et.x, y = Et.y = Math.atan2(J.y - u, c - J.x) * T) : (dt = n.parentNode ? n.parentNode.scrollTop || 0 : 0, pt = n.parentNode ? n.parentNode.scrollLeft || 0 : 0, y = st(n, St), m = st(n, Tt))), x && t && (m > A ? m = A + (m - A) / t : R > m && (m = R - (R - m) / t), bt || (y > L ? y = L + (y - L) / t : z > y && (y = z - (z - y) / t)))
                        },
                        ie = function() {
                        ...
                        re = function(t) {
                            var i, r;
                            if (a && !Et.isPressed && t && !("mousedown" === t.type && C() - ft < 30 && Dt[Et.pointerEvent.type])) {
                                if (ht = ie(), Et.pointerEvent = t, Dt[t.type] ? (ct = -1 !== t.type.indexOf("touch") ? t.currentTarget || t.target : v, Mt(ct, "touchend", ae), Mt(ct, "touchmove", oe), Mt(ct, "touchcancel", ae), Mt(v, "touchstart", jt)) : (ct = null, Mt(v, "mousemove", oe)), vt = null, Mt(v, "mouseup", ae), t && t.target && Mt(t.target, "mouseup", ae), ot = $t.call(Et, t.target) && !s.dragClickables) return Mt(t.target, "change", ae), at(Et, "press", "onPress"), void qt(It, !0);
                                if (mt = !(!ct || Pt === At || l || Et.vars.allowNativeTouchScrolling === !1) && (Pt ? "y" : "x"), k ? t = Z(t, !0) : mt || Et.allowEventDefault || (t.preventDefault(), t.preventManipulation && t.preventManipulation()), t.changedTouches ? (t = Y = t.changedTouches[0], Q = t.identifier) : t.pointerId ? Q = t.pointerId : Y = Q = null, D++, q(Vt), u = Et.pointerY = t.pageY, c = Et.pointerX = t.pageX, (mt || Et.autoScroll) && G(n.parentNode), !Et.autoScroll || bt || l || !n.parentNode || n.getBBox || !n.parentNode._gsMaxScrollX || P.parentNode || (P.style.width = n.parentNode.scrollWidth + "px", n.parentNode.appendChild(P)), ee(), ut && (i = c * ut[0] + u * ut[2] + ut[4], u = c * ut[1] + u * ut[3] + ut[5], c = i), Et.tween && Et.tween.kill(), Et.isThrowing = !1, e.killTweensOf(l || n, !0, Ht), l && e.killTweensOf(n, !0, {
                                        scrollTo: 1
                        ...
                        ae = function(t, i) {
                            if (a && Et.isPressed && (!t || null == Q || i || !(t.pointerId && t.pointerId !== Q || t.changedTouches && !Lt(t.changedTouches, Q)))) {
                                ...
                                var r, o, l, c, u = t,
                                    h = Et.isDragging;
                                if (ct ? (Nt(ct, "touchend", ae), Nt(ct, "touchmove", oe), Nt(ct, "touchcancel", ae), Nt(v, "touchstart", jt)) : Nt(v, "mousemove", oe), Nt(v, "mouseup", ae), t && t.target && Nt(t.target, "mouseup", ae), et = !1, P.parentNode && P.parentNode.removeChild(P), ot) return t && Nt(t.target, "change", ae), qt(It, !1), at(Et, "release", "onRelease"), at(Et, "click", "onClick"), void(ot = !1);
                                if (H(Vt), !bt)
                                    for (o = It.length; --o > -1;) tt(It[o], "cursor", s.cursor || "move");
                                if (h && (Wt = N = C(), Et.isDragging = !1), D--, t) {
                    ...
                    it = Xt.get(this.target), it && it.kill(), this.startDrag = function(t) {
                        ...
                        var e, i, n;
                        return t && s.bounds !== t ? (s.bounds = t, Et.update(!0)) : (Qt(!0), Gt(), x && (e = Et.x, i = Et.y, x && (e > A ? e = A : R > e && (e = R), i > L ? i = L : z > i && (i = z)), (Et.x !== e || Et.y !== i) && (n = !0, Et.x = Et.endX = e, bt ? Et.endRotation = e : Et.y = Et.endY = i, et = !0, Vt()), Et.isThrowing && (n || Et.endX > A || Et.endX < R || Et.endY > L || Et.endY < z) && Jt(s.throwProps, n)), Et)
                    ...
                    }, s)), n.style.overflowY = At && !Rt ? "auto" : "hidden", n.style.overflowX = Pt && !Rt ? "auto" : "hidden", n = l.content), s.force3D !== !1 && e.set(n, {
                        force3D: !0
...
window.SocialShareKit = SocialShareKit,
        ...
        var ArrayProto = Array.prototype,
            ...
            transform, gpuAcceleration, position, bind, unbind, Scrollax = function(t, e, i) {
                ...
                function s(t, e) {
                    ...
                    var i = E.length;
                    if (i)
                        for (var n = 0; n < i; n++) R = E[n], D = R.element, a(D, R, e)
                }
                ...
                var g, m, v, _, y, x, w, b, T, S, C, k, P, A, O, E, R, D, M, N, L, I, j, F = $.extend({}, Scrollax.defaults, e),
                    z = [],
                    q = null,
    ...
    function(t) {
        function e() {
            ...
            }, f = t(".dest"), d = t(window), p = t(".destup"), g = t("#main-nav").height(), m = t("html,body"), v = t(".slide-link"), y = d.innerHeight(), "undefined" != typeof SocialShareKit && SocialShareKit.init(), "undefined" != typeof browserCheck && "ie9" == browserCheck && (bravePlaceholder(), t(".addpl").on("focus", function() {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    }("BezierPlugin"), "undefined" == typeof window.HTMLImports ? jQuery(document).ready(onDocumentReady) : window.addEventListener("HTMLImportsLoaded", onDocumentReady),
    function() {
        function t(t) {
            n = jQuery("#srbt-choose"), jQuery(".srbt-option", n).on("mousedown", i), jQuery(".srbt-close", n).on("mousedown", e)
        }

        function e() {
            n.removeClass("srbt-open"), jQuery(".srbt-disco-content .srbt-option").removeClass("srbt-active")
        }

        function i(t) {
            n.addClass("srbt-open srbt-interacted"), jQuery(".srbt-disco-content .srbt-content").removeClass("srbt-active");
            var e = jQuery(t.target).attr("srbt-value"),
                i = jQuery(".srbt-disco-content ." + e);
            i.addClass("srbt-active")
        }
        "undefined" == typeof window.HTMLImports ? jQuery(document).ready(t) : window.addEventListener("HTMLImportsLoaded", t);
        var n
    }();
