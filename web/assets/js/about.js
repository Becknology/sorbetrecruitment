function onDocumentReady(t) {
    function e() {
        var t = ".about-control",
            e = ".about-option",
            i = ".close-button";
        $(t).attr("about-data-id");
        $(t).click(function(i) {
            var n = $(this).attr("about-data-id");
            i.preventDefault(), $(this).hasClass("active") ? ($(t).removeClass("active"), $(e).removeClass("active"), $(t).removeClass("pulse"), $(".about-original").addClass("active"), $(t).addClass("start")) : ($(t).removeClass("active"), $(t).removeClass("start"), $(t).removeClass("pulse"), $(e).removeClass("active"), $(".about-original").removeClass("active"), $(this).addClass("active"), $(e + "[about-data-id=" + n + "]").addClass("active"))
        }), $(i).click(function(i) {
            i.preventDefault(), $(t).removeClass("active"), $(t).removeClass("start"), $(t).removeClass("pulse"), $(t).addClass("start"), $(e).removeClass("active"), $(".about-original").addClass("active")
        })
    }
    $("#culture-hero-slider").bxSlider({
        touchEnabled: !1,
        mode: "horizontal",
        pagerCustom: "#culture-hero .srbt-pager-custom",
        nextSelector: $("#culture-hero .srbt-next-control"),
        prevSelector: $("#culture-hero .srbt-prev-control"),
        nextText: "next",
        prevText: "prev",
        infiniteLoop: !0
    }), e()
...
function loadBravePostSlider(t) {
    function e() {
        s.each(function(t) {
            var e = 0;
            $(this).children(".brave-post-slide").each(function(t) {
    ...
    function i() {
        var t = $(window).width();
        t <= 990 ? $(".brave-post-slide").each(function(e) {
            $(this).width(t)
        }) : $(".brave-post-slide").each(function(t) {
            $(this).attr("style", "")
        })
    }
    ...
    function n() {
        o.each(function(t) {
            var e = $(window).width(),
                i = s.width(),
                n = i - e,
                r = $(this).children(".prev-btn"),
                o = $(this).children(".next-btn"),
                a = Math.abs($(this).children(".brave-slider-wrapper").offset().left);
            0 == a ? r.css({
                opacity: "0",
                left: "-80px",
                visibility: "hidden"
    ...
    function r() {
        var t = 0,
            e = 1;
        $(".brave-slider-wrapper").css("margin-left", 0), $(".brave-post-slider").attr("remaining-amount", t), $(".brave-post-slider").attr("slide-count", e)
    }
    var o = $(".brave-post-slider"),
        s = $(".brave-slider-wrapper"),
        a = ($(".brave-post-slide"), $(".prev-btn")),
        l = $(".next-btn");
    parseInt(s.css("margin-left"));
    a.click(function() {
        var t = $(window).width(),
            e = parseInt($(this).closest(".brave-post-slider").attr("slide-count"), 10),
            i = s.width(),
            r = e - 1,
            o = Math.abs($(this).siblings(".brave-slider-wrapper").offset().left),
            a = $(".brave-post-slide[slide-count=" + r + "]"),
            l = a.width(),
            c = l + -o,
            u = t + o,
            h = i - u,
            f = parseInt($(this).closest(".brave-post-slider").attr("remaining-amount"), 10),
            d = -o + f,
            p = -h + -o;
        $(".brave-post-slide[slide-count=" + e + "]").length && $(".brave-post-slider").hasClass("ready") && (u > l ? u == i ? ($(".brave-post-slider").removeClass("ready"), $(this).siblings(".brave-slider-wrapper").css("margin-left", d), setTimeout(function() {
            $(".brave-post-slider").addClass("ready")
        }, 500)) : ($(".brave-post-slider").removeClass("ready"), $(this).siblings(".brave-slider-wrapper").css("margin-left", c), $(this).closest(".brave-post-slider").attr("slide-count", r), setTimeout(function() {
            $(".brave-post-slider").addClass("ready")
        }, 500)) : ($(".brave-post-slider").removeClass("ready"), $(this).siblings(".brave-slider-wrapper").css("margin-left", p), setTimeout(function() {
            $(".brave-post-slider").addClass("ready")
        ...
        var t = $(window).width(),
            ...
            r = e + 1,
            o = Math.abs($(this).siblings(".brave-slider-wrapper").offset().left),
            a = $(".brave-post-slide[slide-count=" + e + "]"),
            l = a.width(),
            c = -l + -o,
            u = t + o,
            h = i - u,
            f = -h + -o;
        $(".brave-post-slide[slide-count=" + e + "]").length && $(".brave-post-slider").hasClass("ready") && (h > l ? u == i || ($(".brave-post-slider").removeClass("ready"), $(this).siblings(".brave-slider-wrapper").css("margin-left", c), $(this).closest(".brave-post-slider").attr("slide-count", r), setTimeout(function() {
            $(".brave-post-slider").addClass("ready")
        }, 500)) : ($(".brave-post-slider").removeClass("ready"), $(this).siblings(".brave-slider-wrapper").css("margin-left", f), $(this).closest(".brave-post-slider").attr("remaining-amount", h), setTimeout(function() {
            $(".brave-post-slider").addClass("ready")
        }, 1e3))), setTimeout(function() {
            n()
        }, 500)
    ...
    function(t, e, i) {
        ...
        function b(t, e, i, n) {
            ...
            var r, o, s, a, l, c, h = 0,
                ...
                g = e[0],
                m = ot.isFunction(g);
            if (m || d > 1 && "string" == typeof g && !nt.checkClone && Bt.test(g)) return t.each(function(r) {
                var o = t.eq(r);
            ...
            if (d && (r = f(e, t[0].ownerDocument, !1, t, n), o = r.firstChild, 1 === r.childNodes.length && (r = o), o || n)) {
                ...
                if (a)
                    for (c = s[s.length - 1].ownerDocument, ot.map(s, y), h = 0; a > h; h++) l = s[h], Lt.test(l.type || "") && !Ct.access(l, "globalEval") && ot.contains(c, l) && (l.src ? ot._evalUrl && ot._evalUrl(l.src) : ot.globalEval(l.textContent.replace(Wt, "")))
            }
            return t
        }
        ...
        var ut = function(t) {
            ...
            function d(t, e, i) {
                ...
                return e.first ? function(e, i, o) {
                    ...
                    if (s) {
                        ...
                        for (; e = e[n];)
                            if (1 === e.nodeType || r) {
                                if (c = e[z] || (e[z] = {}), l = c[e.uniqueID] || (c[e.uniqueID] = {}), (a = l[n]) && a[0] === $ && a[1] === o) return u[2] = a[2];
            ...
            w = e.support = {}, S = e.isXML = function(t) {
                ...
                if ((t.ownerDocument || t) !== R && D(t), i = i.replace(ut, "='$1']"), w.matchesSelector && N && !W[i + " "] && (!I || !I.test(i)) && (!L || !L.test(i))) try {
                    var n = F.call(t, i);
                ...
                var e, i = [],
                    n = 0,
                    r = 0;
                if (E = !w.detectDuplicates, O = !w.sortStable && t.slice(0), t.sort(Y), E) {
                        ...
                        return 1 === n && 0 === r ? function(t) {
                            ...
                            if (m) {
                                ...
                                if (p = [s ? m.firstChild : m.lastChild], s && _) {
                                    for (f = m, h = f[z] || (f[z] = {}), u = h[f.uniqueID] || (h[f.uniqueID] = {}), c = u[t] || [], d = c[0] === $ && c[1], y = d && c[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (y = d = 0) || p.pop();)
                                        if (1 === f.nodeType && ++y && f === e) {
                                            u[t] = [$, d, y];
                                            break
                                        }
                                } else if (_ && (f = e, h = f[z] || (f[z] = {}), u = h[f.uniqueID] || (h[f.uniqueID] = {}), c = u[t] || [], d = c[0] === $ && c[1], y = d), y === !1)
                                    for (;
                                        (f = ++d && f && f[g] || (y = d = 0) || p.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++y || (_ && (h = f[z] || (f[z] = {}), u = h[f.uniqueID] || (h[f.uniqueID] = {}), u[t] = [$, y]), f !== e)););
            ...
            }, w.sortStable = z.split("").sort(Y).join("") === z, w.detectDuplicates = !!E, D(), w.sortDetached = r(function(t) {
            ...
            mouseHooks: {
                ...
                filter: function(t, e) {
                    ...
                    return null == t.pageX && null != e.clientX && (i = t.target.ownerDocument || Q,
                        n = i.documentElement, r = i.body, t.pageX = e.clientX + (n && n.scrollLeft || r && r.scrollLeft || 0) - (n && n.clientLeft || r && r.clientLeft || 0), t.pageY = e.clientY + (n && n.scrollTop || r && r.scrollTop || 0) - (n && n.clientTop || r && r.clientTop || 0)), t.which || void 0 === o || (t.which = 1 & o ? 1 : 2 & o ? 3 : 4 & o ? 2 : 0), t
                }
            },
            fix: function(t) {
        ...
        ot.extend({
            ...
            html: function(t) {
                return Tt(this, function(t) {
                    ...
                    if ("string" == typeof t && !Ht.test(t) && !It[(Nt.exec(t) || ["", ""])[1].toLowerCase()]) {
        ...
        Ae.href = me.href, ot.extend({
            ...
            ajax: function(e, i) {
                ...
                if (f.data && f.processData && "string" != typeof f.data && (f.data = ot.param(f.data, f.traditional)), H(Ce, f, i, b), 2 === x) return b;
            ...
            if (!t(o).data("bxSlider")) {
                var l = function() {
                    ...
                    h = function() {
                        ...
                        r.loader.remove(), _(), "vertical" === r.settings.mode && (r.settings.adaptiveHeight = !0), r.viewport.height(f()), o.redrawSlider(), r.settings.onSliderLoad.call(o, r.active.index), r.initialized = !0, r.settings.responsive && t(window).bind("resize", X), r.settings.auto && r.settings.autoStart && (m() > 1 || r.settings.autoSlideForOnePage) && N(), r.settings.ticker && L(), r.settings.pager && E(r.settings.startSlide), r.settings.controls && M(), r.settings.touchEnabled && !r.settings.ticker && z(), r.settings.keyboardEnabled && !r.settings.ticker && t(document).keydown(j)
                    },
                    f = function() {
                        var e = 0,
                            n = t();
                    ...
                    q = function(t) {
                        if (r.controls.el.addClass("disabled"), r.working) t.preventDefault(), r.controls.el.removeClass("disabled");
                            ...
                            r.touch.start.x = i[0].pageX, r.touch.start.y = i[0].pageY, r.viewport.get(0).setPointerCapture && (r.pointerId = e.pointerId, r.viewport.get(0).setPointerCapture(r.pointerId)), r.viewport.bind("touchmove MSPointerMove pointermove", H), r.viewport.bind("touchend MSPointerUp pointerup", B), r.viewport.bind("MSPointerCancel pointercancel", $)
                        }
                    },
                    $ = function(t) {
                        y(r.touch.originalPos.left, "reset", 0), r.controls.el.removeClass("disabled"), r.viewport.unbind("MSPointerCancel pointercancel", $), r.viewport.unbind("touchmove MSPointerMove pointermove", H), r.viewport.unbind("touchend MSPointerUp pointerup", B), r.viewport.get(0).releasePointerCapture && r.viewport.get(0).releasePointerCapture(r.pointerId)
                    },
                    H = function(t) {
                        var e = t.originalEvent,
                            i = "undefined" != typeof e.changedTouches ? e.changedTouches : [e],
                    ...
                    B = function(t) {
                        r.viewport.unbind("touchmove MSPointerMove pointermove", H), r.controls.el.removeClass("disabled");
                        var e = t.originalEvent,
                            i = "undefined" != typeof e.changedTouches ? e.changedTouches : [e],
                            n = 0,
                            s = 0;
                        r.touch.end.x = i[0].pageX, r.touch.end.y = i[0].pageY, "fade" === r.settings.mode ? (s = Math.abs(r.touch.start.x - r.touch.end.x), s >= r.settings.swipeThreshold && (r.touch.start.x > r.touch.end.x ? o.goToNextSlide() : o.goToPrevSlide(), o.stopAuto())) : ("horizontal" === r.settings.mode ? (s = r.touch.end.x - r.touch.start.x, n = r.touch.originalPos.left) : (s = r.touch.end.y - r.touch.start.y, n = r.touch.originalPos.top), !r.settings.infiniteLoop && (0 === r.active.index && s > 0 || r.active.last && 0 > s) ? y(n, "reset", 200) : Math.abs(s) >= r.settings.swipeThreshold ? (0 > s ? o.goToNextSlide() : o.goToPrevSlide(), o.stopAuto()) : y(n, "reset", 200)), r.viewport.unbind("touchend MSPointerUp pointerup", B), r.viewport.get(0).releasePointerCapture && r.viewport.get(0).releasePointerCapture(r.pointerId)
                    },
                    X = function(e) {
                        if (r.initialized)
                            if (r.working) window.setTimeout(X, 10);
                            else {
                ...
                return o.goToSlide = function(e, i) {
                    ...
                    r.children.add(o.find(".srbt-clone")).outerWidth(p()), r.viewport.css("height", f()), r.settings.ticker || _(), r.active.last && (r.active.index = m() - 1), r.active.index >= m() && (r.active.last = !0), r.settings.pager && !r.settings.pagerCustom && (x(), E(r.active.index)), r.settings.ariaHidden && W(r.active.index * v())
                }, o.destroySlider = function() {
                    r.initialized && (r.initialized = !1, t(".srbt-clone", this).remove(), r.children.each(function() {
                        void 0 !== t(this).data("origStyle") ? t(this).attr("style", t(this).data("origStyle")) : t(this).removeAttr("style")
                    }), void 0 !== t(this).data("origStyle") ? this.attr("style", t(this).data("origStyle")) : t(this).removeAttr("style"), t(this).unwrap().unwrap(), r.controls.el && r.controls.el.remove(), r.controls.next && r.controls.next.remove(), r.controls.prev && r.controls.prev.remove(), r.pagerEl && r.settings.controls && !r.settings.pagerCustom && r.pagerEl.remove(), t(".srbt-caption", this).remove(), r.controls.autoEl && r.controls.autoEl.remove(), clearInterval(r.interval), r.settings.responsive && t(window).unbind("resize", X), r.settings.keyboardEnabled && t(document).unbind("keydown", j), t(this).removeData("bxSlider"))
            ...
            function() {
                ...
                var u, h, f, d, p, g, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                    ...
                    Q = s.getStyle = function(t, e, i, n, r) {
                        var o;
                        return H || "opacity" !== e ? (!n && t.style[e] ? o = t.style[e] : (i = i || V(t)) ? o = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(C, "-$1").toLowerCase()) : t.currentStyle && (o = t.currentStyle[e]), null == r || o && "none" !== o && "auto" !== o && "auto auto" !== o ? o : r) : B(t)
                    },
                    ...
                    K = function(t, e) {
                        ...
                        return H || (o.opacity = B(t)), n = Ft(t, e, !1), o.rotation = n.rotation, o.skewX = n.skewX, o.scaleX = n.scaleX, o.scaleY = n.scaleY, o.x = n.x, o.y = n.y, Pt && (o.z = n.z, o.rotationX = n.rotationX, o.rotationY = n.rotationY, o.scaleZ = n.scaleZ), o.filters && delete o.filters, o
                    },
                ...
                var ft = function(t, e, i, n) {
                    ...
                    vt = s.parseComplex = function(t, e, i, n, r, o, s, a, l, c) {
                        ...
                        for ((-1 !== n.indexOf(",") || -1 !== i.indexOf(",")) && (k = k.join(" ").replace(R, ", ").split(" "), P = P.join(" ").replace(R, ", ").split(" "), A = k.length), A !== P.length && (k = (o || "").split(" "), A = k.length), s.plugin = l, s.setRatio = c, ht.lastIndex = 0, h = 0; A > h; h++)
                            ...
                            else if (r && ht.test(p)) S = "," === g.charAt(g.length - 1) ? ")," : ")", C = -1 !== g.indexOf("hsl") && H, p = ct(p, C), g = ct(g, C), w = p.length + g.length > 6, w && !H && 0 === g[3] ? (s["xs" + s.l] += s.l ? " transparent" : "transparent", s.e = s.e.split(P[h]).join("transparent")) : (H || (w = !1), C ? s.appendXtra(w ? "hsla(" : "hsl(", p[0], rt(g[0], p[0]), ",", !1, !0).appendXtra("", p[1], rt(g[1], p[1]), "%,", !1).appendXtra("", p[2], rt(g[2], p[2]), w ? "%," : "%" + S, !1) : s.appendXtra(w ? "rgba(" : "rgb(", p[0], g[0] - p[0], ",", !0, !0).appendXtra("", p[1], g[1] - p[1], ",", !0).appendXtra("", p[2], g[2] - p[2], w ? "," : S, !0), w && (p = p.length < 4 ? 1 : p[3], s.appendXtra("", p, (g.length < 4 ? 1 : g[3]) - p, S, !1))), ht.lastIndex = 0;
                        else if (_ = p.match(m)) {
                        ...
                        if (!l[t]) {
                            ...
                            xt(t, {
                                parser: function(t, i, n, r, o, s, c) {
                                    ...
                                    return u ? (u._cssRegister(), l[n].parse(t, i, n, r, o, s, c)) : (X("Error: " + e + " js file not loaded."), o)
                                }
                            })
                        }
                    };
                ...
                var bt, Tt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                        ...
                        if (d.svg = !(!t.getBBox || !Nt(t)), d.svg && (Mt(t, Q(t, kt, r, !1, "50% 50%") + "", d, t.getAttribute("data-svg-origin")), bt = s.useSVGTransformAttr || Rt), a = It(t), a !== Lt) {
                            if (16 === a.length) {
                                ...
                                var $ = a.length >= 6,
                                    ...
                                    X = a[2] || 0,
                                    W = $ ? a[3] : 1;
                                d.x = a[4] || 0, d.y = a[5] || 0, c = Math.sqrt(H * H + B * B), u = Math.sqrt(W * W + X * X), h = H || B ? Math.atan2(B, H) * N : d.rotation || 0, f = X || W ? Math.atan2(X, W) * N + h : d.skewX || 0, Math.abs(f) > 90 && Math.abs(f) < 270 && (p ? (c *= -1, f += 0 >= h ? 180 : -180, h += 0 >= h ? 180 : -180) : (u *= -1, f += 0 >= f ? 180 : -180)), d.scaleX = c, d.scaleY = u, d.rotation = h, d.skewX = f, Pt && (d.rotationX = d.rotationY = d.z = 0, d.perspective = _, d.scaleZ = 1), d.svg && (d.x -= d.xOrigin - (d.xOrigin * H + d.yOrigin * X), d.y -= d.yOrigin - (d.xOrigin * B + d.yOrigin * W))
                            }
                            d.zOrigin = v;
                        ...
                        if (f) {
                            ...
                            if (null != n.ox && (d = (n.oxp ? m * n.ox * .01 : n.ox) - m / 2, p = (n.oyp ? v * n.oy * .01 : n.oy) - v / 2, b += d - (d * a + p * l), T += p - (d * c + p * u)), _ ? (d = m / 2, p = v / 2, y += ", Dx=" + (d - (d * a + p * l) + b) + ", Dy=" + (p - (d * c + p * u) + T) + ")") : y += ", sizingMethod='auto expand')", -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? h.filter = e.replace(D, y) : h.filter = y + " " + e, (0 === t || 1 === t) && 1 === a && 0 === l && 0 === c && 1 === u && (_ && -1 === y.indexOf("Dx=0, Dy=0") || w.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && h.removeAttribute("filter")), !_) {
                                ...
                                for (d = n.ieOffsetX || 0, p = n.ieOffsetY || 0, n.ieOffsetX = Math.round((m - ((0 > a ? -a : a) * m + (0 > l ? -l : l) * v)) / 2 + b), n.ieOffsetY = Math.round((v - ((0 > u ? -u : u) * v + (0 > c ? -c : c) * m)) / 2 + T), _t = 0; 4 > _t; _t++) C = et[_t], S = f[C],
                                    i = -1 !== S.indexOf("px") ? parseFloat(S) : G(this.t, C, parseFloat(S), S.replace(x, "")) || 0, k = i !== n[C] ? 2 > _t ? -n.ieOffsetX : -n.ieOffsetY : 2 > _t ? d - n.ieOffsetX : p - n.ieOffsetY, h[C] = (n[C] = Math.round(i - k * (0 === _t || 2 === _t ? 1 : P))) + "px"
                            }
                        }
                    },
                    zt = q.set3DTransformRatio = q.setTransformRatio = function(t) {
                        ...
                        c = 1, n = s = a = l = u = h = 0, f = j ? -1 / j : 0, p = C.zOrigin, g = 1e-6, w = ",", b = "0", P = O * M, P && (m = Math.cos(P), v = Math.sin(P), a = -v, u = f * -v, n = e * v, s = r * v, c = m, f *= m, e *= m, r *= m), P = A * M, P && (m = Math.cos(P), v = Math.sin(P), _ = i * m + n * v, y = o * m + s * v, l = c * v, h = f * v, n = i * -v + n * m, s = o * -v + s * m, c *= m, f *= m, i = _, o = y), 1 !== R && (n *= R, s *= R, c *= R, f *= R), 1 !== D && (i *= D, o *= D, l *= D, h *= D), 1 !== E && (e *= E, r *= E, a *= E, u *= E), (p || F) && (p && (N += n * -p, L += s * -p, I += c * -p + p), F && (N += C.xOrigin - (C.xOrigin * e + C.yOrigin * i) + C.xOffset, L += C.yOrigin - (C.xOrigin * r + C.yOrigin * o) + C.yOffset), g > N && N > -g && (N = b), g > L && L > -g && (L = b), g > I && I > -g && (I = 0)), x = C.xPercent || C.yPercent ? "translate(" + C.xPercent + "%," + C.yPercent + "%) matrix3d(" : "matrix3d(", x += (g > e && e > -g ? b : e) + w + (g > r && r > -g ? b : r) + w + (g > a && a > -g ? b : a), x += w + (g > u && u > -g ? b : u) + w + (g > i && i > -g ? b : i) + w + (g > o && o > -g ? b : o), A || O || 1 !== R ? (x += w + (g > l && l > -g ? b : l) + w + (g > h && h > -g ? b : h) + w + (g > n && n > -g ? b : n), x += w + (g > s && s > -g ? b : s) + w + (g > c && c > -g ? b : c) + w + (g > f && f > -g ? b : f) + w) : x += ",0,0,0,0,1,0,", x += N + w + L + w + I + w + (j ? 1 + -I / j : 1) + ")", k[St] = x
                    };
                ...
                xt("opacity,alpha,autoAlpha", {
                    ...
                    parser: function(t, e, i, n, o, s) {
                        var a = parseFloat(Q(t, "opacity", r, !1, "1")),
                            l = t.style,
                            c = "autoAlpha" === i;
                        return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + a), c && 1 === a && "hidden" === Q(t, "visibility", r) && 0 !== e && (a = 0), H ? o = new gt(l, "opacity", a, e - a, o) : (o = new gt(l, "opacity", 100 * a, 100 * (e - a), o), o.xn1 = c ? 1 : 0, l.zoom = 1, o.type = 2, o.b = "alpha(opacity=" + o.s + ")", o.e = "alpha(opacity=" + (o.s + o.c) + ")", o.data = t, o.plugin = s, o.setRatio = qt), c && (o = new gt(l, "visibility", 0, 0, o, (-1), null, (!1), 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit"), o.xs0 = "inherit", n._overwriteProps.push(o.n), n._overwriteProps.push(i)), o
                    }
                });
                var $t = function(t, e) {
                ...
                xt("className", {
                    parser: function(t, e, n, o, s, a, l) {
                        var c, u, h, f, d, p = t.getAttribute("class") || "",
                            g = t.style.cssText;
                        if (s = o._classNamePT = new gt(t, n, 0, 0, s, 2), s.setRatio = Ht, s.pr = -11, i = !0, s.b = p, u = K(t, r), h = t._gsClassPT) {
                ...
                var Bt = function(t) {
                    if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                        ...
                        if ("all" === this.e) s.cssText = "", r = !0;
                            ...
                            for (e = this.e.split(" ").join("").split(","), n = e.length; --n > -1;) i = e[n], l[i] && (l[i].parse === a ? r = !0 : i = "transformOrigin" === i ? kt : l[i].p), $t(s, i);
                ...
                for (xt("clearProps", {
                        parser: function(t, e, n, r, o) {
                            return o = new gt(t, n, 0, 0, o, 2), o.setRatio = Bt, o.e = e, o.pr = -10, o.data = r._tween, i = !0, o
                        }
                ...
                c = s.prototype, c._firstPT = c._lastParsedTransform = c._transform = null, c._onInitTween = function(t, e, a) {
                    ...
                    if (h && "" === T.zIndex && (c = Q(t, "zIndex", r), ("auto" === c || "" === c) && this._addLazySet(T, "zIndex", 0)), "string" == typeof e && (m = T.cssText, c = K(t, r), T.cssText = m + ";" + e, c = J(t, c, K(t)).difs, !H && b.test(e) && (c.opacity = parseFloat(RegExp.$1)), e = c, T.cssText = m), e.className ? this._firstPT = d = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = d = this.parse(t, e, null), this._transformType) {
                ...
                var Wt = function(t, e, i) {
                    ...
                    if (t.slice)
                        ...
                        for (n = t.childNodes, r = n.length; --r > -1;) o = n[r], s = o.type, o.style && (e.push(K(o)), i && i.push(o)), 1 !== s && 9 !== s && 11 !== s || !o.childNodes.length || Wt(o, e, i)
                };
                return s.cascadeTo = function(t, i, n) {
                    ...
                    for (t = l._targets || l.target, Wt(t, u, f), l.render(i, !0, !0), Wt(t, h), l.render(0, !0, !0), l._enabled(!0), r = f.length; --r > -1;)
    ...
    function(t, e) {
        ...
        if (!i.TweenLite) {
                ...
                if (this._timeline) {
                    if (0 > t && !i && (t += this.totalDuration()), this._timeline.smoothChildTiming) {
                        ...
                        var n = this._totalDuration,
                            r = this._timeline;
                        if (t > n && !i && (t = n),
                            this._startTime = (this._paused ? this._pauseTime : r._time) - (this._reversed ? n - t : t) / this._timeScale, r._dirty || this._uncache(!1), r._timeline)
            ...
            var D = v("TweenLite", function(e, i, n) {
                ...
                M = function(t, e) {
                    var i, n = {};
                    for (i in t) X[i] || i in e && "transform" !== i && "x" !== i && "y" !== i && "width" !== i && "height" !== i && "className" !== i && "border" !== i || !(!$[i] || $[i] && $[i]._autoCSS) || (n[i] = t[i], delete t[i]);
                    t.css = n
                };
            ...
            U._startTime = s.time, Y._startTime = s.frame, U._active = Y._active = !0, setTimeout(Q, 1), A._updateRoot = D.render = function() {
                var t, e, i;
                if (N.length && Q(), U.render((s.time - U._startTime) * U._timeScale, !1, !1), Y.render((s.frame - Y._startTime) * Y._timeScale, !1, !1), N.length && Q(), s.frame >= V) {
            ...
            var G = function(t, e, i) {
                    ...
                    if (H[o || (t._gsTweenID = o = "t" + B++)] || (H[o] = {
                            target: t,
                            tweens: []
                        }), e && (n = H[o].tweens, n[r = n.length] = e, i))
            ...
            o._init = function() {
                ...
                var o, s, a, l, c, u;
                if (null == e) return !1;
                L[e._gsTweenID] && Q(), this.vars.css || e.style && e !== t && e.nodeType && $.css && this.vars.autoCSS !== !1 && M(this.vars, e);
                for (o in this.vars)
                    if (u = this.vars[o], X[o]) u && (u instanceof Array || u.push && d(u)) && -1 !== u.join("").indexOf("{self}") && (this.vars[o] = u = this._swapSelfInParams(u, this));
        ...
        _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function(t, e, i) {
            var n, r, o, s, a, l, c, u, h = {
                ...
                wt = function(t) {
                    ...
                    if (Bt.cacheSVGData !== !1 && t._gsCache && t._gsCache.lastUpdate === e.ticker.frame) return t._gsCache;
                ...
                At = function(t, e, i) {
                    ...
                    if (t === window) s = X(), r = W(), o = r + (_.clientWidth || t.innerWidth || v.body.clientWidth || 0), a = s + ((t.innerHeight || 0) - 20 < _.clientHeight ? _.clientHeight : t.innerHeight || v.body.clientHeight || 0);
                    else {
                ...
                Ht = function(t, i) {
                    ...
                    ut && i.force3D !== !1 ? (a = "translate3d(", l = "px,0px)") : ft && (a = "translate(", l = "px)"), this.scrollTop = function(t, e) {
                        ...
                        return (o > 2 || -2 > o) && !r ? (m = t.scrollLeft, e.killTweensOf(this, !0, {
                            left: 1,
                            scrollLeft: 1
                        }), this.left(-m), void(i.onKill && i.onKill())) : (n = -n, 0 > n ? (p = n - .5 | 0, n = 0) : n > w ? (p = n - w | 0, n = w) : p = 0, (p || s) && (a ? this._suspendTransforms || (h[ft] = a + -p + "px," + -d + l) : h.left = -p + "px", $t && p + x >= 0 && (h.paddingRight = p + x + "px")), t.scrollLeft = 0 | n, void(m = t.scrollLeft))
                ...
                Bt = function(n, s) {
                    ...
                    var a, l, c, u, m, y, x, b, A, D, L, z, H, X, W, Q, J, et, it, nt, rt, ot, ct, ut, ht, ft, dt, pt, gt, mt, vt, _t, yt, xt = (s.type || (k ? "top,left" : "x,y")).toLowerCase(),
                        ...
                        Xt = 0,
                        Wt = !1,
                        Yt = s.clickableTest || zt,
                        Vt = function(t) {
                            if (Et.autoScroll && (Wt || Et.isDragging && et)) {
                                ...
                                for (Wt = !1, I.scrollTop = null != window.pageYOffset ? window.pageYOffset : null != _.scrollTop ? _.scrollTop : v.body.scrollTop, I.scrollLeft = null != window.pageXOffset ? window.pageXOffset : null != _.scrollLeft ? _.scrollLeft : v.body.scrollLeft, o = Et.pointerX - I.scrollLeft, s = Et.pointerY - I.scrollTop; h && !i;) i = V(h.parentNode), e = i ? I : h.parentNode, r = i ? {
                                    ...
                                    left: 0,
                                    top: 0
                                } : e.getBoundingClientRect(), a = c = 0, At && (u = e._gsMaxScrollY - e.scrollTop, 0 > u ? c = u : s > r.bottom - 40 && u ? (Wt = !0, c = Math.min(u, f * (1 - Math.max(0, r.bottom - s) / 40) | 0)) : s < r.top + 40 && e.scrollTop && (Wt = !0, c = -Math.min(e.scrollTop, f * (1 - Math.max(0, s - r.top) / 40) | 0)), c && (e.scrollTop += c)), Pt && (u = e._gsMaxScrollX - e.scrollLeft, 0 > u ? a = u : o > r.right - 40 && u ? (Wt = !0, a = Math.min(u, f * (1 - Math.max(0, r.right - o) / 40) | 0)) : o < r.left + 40 && e.scrollLeft && (Wt = !0, a = -Math.min(e.scrollLeft, f * (1 - Math.max(0, o - r.left) / 40) | 0)), a && (e.scrollLeft += a)), i && (a || c) && (window.scrollTo(e.scrollLeft, e.scrollTop), se(Et.pointerX + a, Et.pointerY + c)), h = e
                            }
                            if (et) {
                                var d = Et.x,
                                    p = Et.y,
                        ...
                        re = function(t) {
                            ...
                            if (a && !Et.isPressed && t && !("mousedown" === t.type && C() - ft < 30 && Rt[Et.pointerEvent.type])) {
                                if (ht = ie(), Et.pointerEvent = t, Rt[t.type] ? (ct = -1 !== t.type.indexOf("touch") ? t.currentTarget || t.target : v, Mt(ct, "touchend", ae), Mt(ct, "touchmove", oe), Mt(ct, "touchcancel", ae), Mt(v, "touchstart", Ft)) : (ct = null, Mt(v, "mousemove", oe)), vt = null, Mt(v, "mouseup", ae), t && t.target && Mt(t.target, "mouseup", ae), ot = Yt.call(Et, t.target) && !s.dragClickables) return Mt(t.target, "change", ae), at(Et, "press", "onPress"), void qt(It, !0);
                                if (mt = !(!ct || Pt === At || l || Et.vars.allowNativeTouchScrolling === !1) && (Pt ? "y" : "x"), k ? t = Z(t, !0) : mt || Et.allowEventDefault || (t.preventDefault(), t.preventManipulation && t.preventManipulation()), t.changedTouches ? (t = W = t.changedTouches[0], Q = t.identifier) : t.pointerId ? Q = t.pointerId : W = Q = null, R++, q(Vt), u = Et.pointerY = t.pageY, c = Et.pointerX = t.pageX, (mt || Et.autoScroll) && G(n.parentNode), !Et.autoScroll || bt || l || !n.parentNode || n.getBBox || !n.parentNode._gsMaxScrollX || P.parentNode || (P.style.width = n.parentNode.scrollWidth + "px", n.parentNode.appendChild(P)), ee(), ut && (i = c * ut[0] + u * ut[2] + ut[4], u = c * ut[1] + u * ut[3] + ut[5], c = i), Et.tween && Et.tween.kill(), Et.isThrowing = !1, e.killTweensOf(l || n, !0, $t), l && e.killTweensOf(n, !0, {
                                        scrollTo: 1
                                    }), Et.tween = Et.lockedAxis = null, (s.zIndexBoost || !bt && !l && s.zIndexBoost !== !1) && (n.style.zIndex = Bt.zIndex++), Et.isPressed = !0, b = !(!s.onDrag && !Et._listeners.drag), !bt)
                        ...
                        oe = function(t) {
                            ...
                            if (a && !r && Et.isPressed && t) {
                                ...
                                Et.autoScroll && (Wt = !0), se(t.pageX, t.pageY)
                            }
                        },
                        se = function(t, e) {
                        ...
                        ae = function(t, i) {
                            if (a && Et.isPressed && (!t || null == Q || i || !(t.pointerId && t.pointerId !== Q || t.changedTouches && !Lt(t.changedTouches, Q)))) {
                                ...
                                if (h && (Xt = N = C(), Et.isDragging = !1), R--, t) {
                                    if (k && (t = Z(t, !1)), r = t.changedTouches, r && (t = r[0], t !== W && t.identifier !== Q)) {
                                ...
                                }))) : (Jt(s.throwProps), k || Et.allowEventDefault || !u || !s.dragClickables && Yt.call(Et, u.target) || !h || mt && (!vt || mt !== vt) || u.cancelable === !1 || (u.preventDefault(), u.preventManipulation && u.preventManipulation()), at(Et, "release", "onRelease")), h && at(Et, "dragend", "onDragEnd"), !0
                            }
                        },
                        le = function(t) {
                            if (t && Et.isDragging) {
                    ...
                    it = Bt.get(this.target), it && it.kill(), this.startDrag = function(t) {
                        ...
                        var i = Et.x,
                            r = Et.y;
                        return te(), t ? Et.applyBounds() : (et && e && Vt(), Qt(!0)), Et.isPressed && (Pt && Math.abs(i - Et.x) > .01 || At && Math.abs(r - Et.y) > .01 && !bt) && ee(), Et.autoScroll && (G(n.parentNode), Wt = !0, Vt()), Et
                        ...
                        return Y(Et.target, le), a = !0, o && "soft" !== t && o.track(l || n, wt ? "x,y" : bt ? "rotation" : "top,left"), l && l.enable(), n._gsDragID = r = "d" + E++, O[r] = this, l && (l.element._gsDragID = r), e.set(n, {
                            x: "+=0",
                            overwrite: !1
                        }), gt = {
                            t: n,
                            data: k ? X : n._gsTransform,
                            tween: {},
                            setRatio: k ? function() {
                                e.set(n, H)
                        ...
                        return U(n, le), a = !1, o && "soft" !== t && o.untrack(l || n, wt ? "x,y" : bt ? "rotation" : "top,left"), l && l.disable(), $(Vt), Et.isDragging = Et.isPressed = ot = !1, r && at(Et, "dragend", "onDragEnd"), Et
                    }, this.enabled = function(t, e) {
                        return arguments.length ? t ? Et.enable(e) : Et.disable(e) : a
                    }, this.kill = function() {
                        return Et.isThrowing = !1, e.killTweensOf(l || n, !0, $t), Et.disable(), delete O[n._gsDragID], Et
                    }, -1 !== xt.indexOf("scroll") && (l = this.scrollProxy = new Ht(n, B({
                        onKill: function() {
                        ...
                        force3D: !0
                    }), bt ? $t.rotation = 1 : (Pt && ($t[Tt] = 1), At && ($t[St] = 1)), bt ? (H = p, X = H.css, H.overwrite = !1) : wt && (H = Pt && At ? h : Pt ? f : d, X = H.css, H.overwrite = !1), this.enable()
                },
                Xt = Bt.prototype = new t;
            Xt.constructor = Bt, Xt.pointerX = Xt.pointerY = 0, Xt.isDragging = Xt.isPressed = !1, Bt.version = "0.14.3", Bt.zIndex = 1e3, Mt(v, "touchcancel", function() {}), Mt(v, "contextmenu", function(t) {
                var e;
                for (e in O) O[e].isPressed && O[e].endDrag()
            }), Bt.create = function(t, i) {
                "string" == typeof t && (t = e.selector(t));
                for (var n = t && 0 !== t.length ? Ot(t) ? Et(t) : [t] : [], r = n.length; --r > -1;) n[r] = new Bt(n[r], i);
                return n
            }, Bt.get = function(t) {
            ...
            var Wt = {},
                ...
                Ut = function(t, e) {
                    if (t === window) return Wt.left = Wt.top = 0, Wt.width = Wt.right = _.clientWidth || t.innerWidth || v.body.clientWidth || 0, Wt.height = Wt.bottom = (t.innerHeight || 0) - 20 < _.clientHeight ? _.clientHeight : t.innerHeight || v.body.clientHeight || 0, Wt;
                    var i = t.pageX !== e ? {
                        left: t.pageX - W(),
                        top: t.pageY - X(),
                        right: t.pageX - W() + 1,
                        bottom: t.pageY - X() + 1
                    } : t.nodeType || t.left === e || t.top === e ? k ? Yt(t) : K(t).getBoundingClientRect() : t;
            ...
            }, P.style.cssText = "visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;", Bt
        }, !0)
    }), _gsScope._gsDefine && _gsScope._gsQueue.pop()(),
    function(t) {
        "use strict";
    ...
    function(t) {
        ...
        var ArrayProto = Array.prototype,
            ...
            transform, gpuAcceleration, position, bind, unbind, Scrollax = function(t, e, i) {
                function n() {
                    return q = Y ? $doc.find(H) : f.find(H), z.length = 0, b = !!j.horizontal, q.each(U), o(), j.performanceTrick && (_ = Y ? $doc : f), c("load"), h
                }
...
}), "undefined" == typeof window.HTMLImports ? jQuery(document).ready(onDocumentReady) : window.addEventListener("HTMLImportsLoaded", onDocumentReady), "undefined" == typeof window.HTMLImports ? jQuery(document).ready(loadBravePostSlider) : window.addEventListener("HTMLImportsLoaded", loadBravePostSlider);

$("#whyus-animating-block a.tab-link").click(function(e) {
    if (this.hash !== "") {
        event.preventDefault();

        var sceneName = this.hash.substring(1);
        console.log(sceneName);

        $("#whyus-animating-block").addClass("active");

        $("#whyus-animating-block .tab-content").removeClass("active");
        $("#whyus-animating-block .tab-content."+sceneName ).addClass("active");
    }
});

$("#whyus-animating-block button.tab-close").click(function(e) {
    $("#whyus-animating-block").removeClass("active");
});